document.addEventListener('DOMContentLoaded', () => {
    fetch('https://loantest.innovatixtechnologies.com/account/example-app/public/api/form-show-admin', {
        method: 'GET',
        headers: {
                ...
                document.querySelectorAll('.lead-row-delete-btn').forEach(button => {
                    button.addEventListener('click', () => {
                        ...
                        showConfirm("Are you sure you want to delete this data?", () => {
                            fetch(`https://loantest.innovatixtechnologies.com/account/example-app/public/api/form-delete/admin/${id}`, {
                                method: 'DELETE',
                                headers: {

...
function fetchOtherData(id) {
    fetch(`https://loantest.innovatixtechnologies.com/account/example-app/public/api/other/show/admin/${id}`, {
        headers: {
...
function fetchFollowUpData(id) {
    fetch(`https://loantest.innovatixtechnologies.com/account/example-app/public/api/otherfollowup-list/admin/${id}`, {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${localStorage.getItem("token")}`,
...
async function handleFormSubmission(e) {
    ...
    try {
        const response = await fetch(
            `https://loantest.innovatixtechnologies.com/account/example-app/public/api/other/admin/${otherId}`,
            {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',

document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("https://loantest.innovatixtechnologies.com/account/example-app/public/api/other-list-admin", {
        method: "GET",
        headers: {
        ...
        .then(response => {
            ...
            document.querySelectorAll('.show-cost-btn').forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    window.location.href = `other-cost.html?id=${id}`;
                });
            });
            ...
            document.querySelectorAll('.show-follow-up-btn').forEach(button => {
                button.addEventListener('click', () => {
                    const id = button.getAttribute('data-id');
                    window.location.href = `other-followup.html?id=${id}`;
                });
            });

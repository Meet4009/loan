...
function fetchMonthlyReport(startDate, endDate) {
    const url = new URL('https://loantest.innovatixtechnologies.com/account/example-app/public/api/monthly-report/admin');
            ...
            document.querySelectorAll('.delete-btn').forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    showConfirm("Are you sure you want to delete this data?", () => {
                        fetch(`https://loantest.innovatixtechnologies.com/account/example-app/public/api/account-delete/admin/${id}`, {
                            method: 'DELETE',
                            headers: {

...
function fetchLeadData(id, token) {
    fetch(`https://loantest.innovatixtechnologies.com/account/example-app/public/api/formdata/${id}`, {
        method: 'GET',
        headers: {
...
async function handleFormSubmission(e) {
    ...
    try {
        const apiUrl = `https://loantest.innovatixtechnologies.com/account/example-app/public/api/form-update/${id}`;

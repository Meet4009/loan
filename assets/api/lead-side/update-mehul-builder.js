...
async function fetchBuilderDetails(id, token) {
    try {
        ...
        const response = await fetch(`https://loantest.innovatixtechnologies.com/account/example-app/public/api/builder-mehul/${id}`, {
            method: 'GET',
            headers: {
...
function fetchFollowUpData(id) {
    fetch(`https://loantest.innovatixtechnologies.com/account/example-app/public/api/builder-follow-up-list/${id}`, {
        method: "GET",
        headers: {
...
async function handleFormSubmission(e) {
    ...
    try {
        const response = await fetch(`https://loantest.innovatixtechnologies.com/account/example-app/public/api/builder-edit/${id}`, {

document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("https://loantest.innovatixtechnologies.com/account/example-app/public/api/builder-list", {
        method: "GET",
        headers: {
        ...
        .then(response => {
            ...
            document.querySelectorAll('.builder-data-update').forEach(button => {
                button.addEventListener('click', () => {
                    const id = button.getAttribute('data-id');
                    window.location.href = `../lead-side/update-mehul-builder.html?id=${id}`;
                });
            });
        })
        .catch(error => {
